                    ...
                    <div class="card-body">
                        ...
                        <form id="customerForm" action="{{ route('customers.update', $customer->id) }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="nic" placeholder="Type here" class="form-control"
                                    id="nic" value="{{ $customer->nic }}" />
                            </div>

                            <div class="row gx-3">
                                <div class="col-md-6 mb-4">
                                    <label for="first_name" class="form-label">Frist Name <span
                            ...
                            <div class="row gx-3">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" name="tax_holder_name" placeholder="Type here"
                                        class="form-control" id="tax_holder_name"
                                        value="{{ $customer->tax_holder_name }}" />
                                </div>
                                <div class="col-md-6 mb-4">
                                    <label for="tax_number" class="form-label">Tax Number</label>
                                    <input type="text" name="tax_number" placeholder="Type here" class="form-control"
                                        id="tax_number" value="{{ $customer->tax_number }}" />
                                </div>
                            </div>
                            <div class="mb-4">
                                <button form="customerForm" class="btn btn-primary col-md-3"
