...
@section('breadcrumb-title')
    <h3>Battery POS Payment Not Completed Report</h3>
@endsection

@section('breadcrumb-items')
    <li class="breadcrumb-item active">Battery POS Payment Not Completed Report</li>
@endsection
            ...
            var table = $('#tableData').DataTable({
                ...
                buttons: [{
                    ...
                    },
                    {
                        extend: 'pdfHtml5',
                        footer: true,
                        title: 'Battery POS Payment Not Completed Report',
