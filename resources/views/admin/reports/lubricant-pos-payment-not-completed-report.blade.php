...
@section('breadcrumb-title')
    <h3>Lubricant POS Payment Not Completed Report</h3>
@endsection

@section('breadcrumb-items')
    <li class="breadcrumb-item active">Lubricant POS Payment Not Completed Report</li>
@endsection
            ...
            var table = $('#tableData').DataTable({
                ...
                buttons: [{
                    ...
                    },
                    {
                        extend: 'pdfHtml5',
                        footer: true,
                        title: 'Lubricant POS Payment Not Completed Report',
