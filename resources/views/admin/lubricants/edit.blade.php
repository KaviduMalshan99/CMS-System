    ...
    <div class="container">
        ...
        <form action="{{ route('lubricants.update', $lubricant->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="purchase_price" value="{{ $lubricant->purchase_price }}"
                    required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="stock_quantity" value="{{ $lubricant->stock_quantity }}"
                    required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                @if ($lubricant->image)
                    <img src="{{ asset('storage/' . $lubricant->image) }}" alt="Lubricant Image" class="img-thumbnail mt-2"
                        width="100">
                @endif
            </div>
