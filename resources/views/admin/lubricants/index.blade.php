                    ...
                    <div class="card-header pb-0 card-no-border">
                        <div class="row gx-3">
                            ...
                            <div class="col-md-2 mb-4">
                                <a href="{{ route('lubricants.create') }}" class="btn btn-primary btn-sm rounded">Add New
                                    Lubricant
                                </a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row">
                                                    {{-- <div class="col">
                                                        <a
                                                        href="{{ route('lubricants.show', $lubricant->id) }}"
                                                        class="btn btn-info p-1" style="display:inline;"><i class="fa fa-dedent"></i></a>
                                                    </div> --}}
                                                    <div class="col-1 mt-1">
                                                        <a href="{{ route('lubricants.edit', $lubricant->id) }}"
                                                            class="btn btn-warning p-1 py-2 " style="display:inline;"><i
                                                                class="fa fa-edit"></i></a>
                                                    </div>
                                                    <div class="col-1 mt-1 ">
                                                        <a href="{{ route('lubricants.history', $lubricant->id) }}"
                                                            class="btn btn-success p-1 py-2 " style="display:inline;"><i
                                                                class="fa fa-eye"></i></a>
                                                    </div>
                                                    <div class="col-1">
                                                        <form action="{{ route('lubricants.destroy', $lubricant->id) }}"
                                                            method="POST" style="display:inline;">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit" class="btn btn-danger p-1"
                                                                onclick="return confirm('Are you sure you want to delete this lubricant?')"><i
