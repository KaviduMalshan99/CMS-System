                                ...
                                <tbody>
                                    @foreach ($purchases as $purchase)
                                        <tr>
                                            ...
                                            <td>
                                                @php
                                                    $lubricantNames = \App\Models\Lubricant::whereIn('id', explode(',', $purchase->lubricant_ids))->pluck('name')->toArray();
                                                @endphp
                                            ...
                                            <td>
                                                <a href="{{ route('lubricant_purchases.bill', ['id' => $purchase->id]) }}" class="text-warning me-2">
                                                    <span class="btn btn-warning p-2">Invoice</span>
                                                </a>
                                            </td>
