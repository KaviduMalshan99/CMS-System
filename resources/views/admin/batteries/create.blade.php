                        ...
                        <form
                            ...
                            <div class="row">
                                <div class="col-sm-6 ">
                                    <!-- Selling Price -->
                                    <div class="form-group   my-3">
                                        <label for="selling_price" class="pb-4 pt-2">Selling Price</label>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group my-3">
                                                <label for="free_replacement" class="pb-3">Free Replacement Period (Months)</label>
                                                <input type="number" name="frp" class="form-control" value="{{ old('frp', $battery->frp ?? '') }}" required>
                                                @error('free_replacement')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group my-3">
                                                <label for="pro_rata" class="pb-3">Pro-Rata Warranty Period (Months)</label>
                                                <input type="number" name="prp" class="form-control" value="{{ old('prp', $battery->prp ?? '') }}" required>
                                                @error('pro_rata')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
