    ...
    <div class="container">
        ...
        <form action="{{ route('admin.old-batteries.update', $battery->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="old_battery_type" class="form-control" value="{{ $battery->old_battery_type }}"
                    required>
            </div>

            <div class="form-group">
                <label for="old_battery_condition">Battery Condition</label>
                <input type="text" name="old_battery_condition" class="form-control"
                    value="{{ $battery->old_battery_condition }}" required>
            </div>

            <div class="form-group">
                <label for="old_battery_value">Battery Value</label>
                <input type="number" name="old_battery_value" class="form-control"
                    value="{{ $battery->old_battery_value }}" required>
            </div>
