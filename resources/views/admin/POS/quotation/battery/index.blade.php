                ...
                <div class="card">
                    <div class="card-header pb-0 card-no-border">
                        <div class="row gx-3">
                            ...
                            <div class="col-md-4 mb-4"><a href="{{ route('battery.quotations.create') }}" class="btn btn-primary mb-3">Create New Quotation</a></div>
                                    ...
                                    @foreach ($quotations as $quotation)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex ">
                                                    <!-- Delete Form -->
                                                    <form action="{{ route('battery.quotations.destroy', $quotation->quotation_id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this quotation?');">
                                                        @csrf
                                                        @method('DELETE')
                                                    ...
                                                    <!-- Invoice Button -->
                                                    <a href="{{ route('battery.quotations.bill', $quotation->id) }}" class="btn btn-warning btn-sm mx-2">
