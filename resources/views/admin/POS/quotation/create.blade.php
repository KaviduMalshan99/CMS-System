    ...
    <div class="container">
        <div class="card">
            <div class="card-body">
                ...
                <form class="row g-3 needs-validation" action="{{ route('quotations.store') }}" method="POST" novalidate>
                    @csrf

                    <input type="hidden" name="type" value="lubricant" id="">
                            ...
                            <select class="form-control" id="quotation_items" name="quotation_items[]" required>
                                @foreach($lubricants as $lubricant)
                                    <option value="{{ $lubricant->id }}" 
                                            data-model="{{ $lubricant->model_no }}" 
                                            data-name="{{ $lubricant->name }}" 
                                            data-sale-price="{{ $lubricant->sale_price }}"
                                            data-type="{{ $lubricant->type }}">  
                                        {{ $lubricant->model_no }} - {{ $lubricant->name }} - {{ $lubricant->type }}
                                    </option>
                                @endforeach
                            </select>
