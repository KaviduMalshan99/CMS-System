...
<html lang="en">
    ...
    <head>
        ...
        <title>Lubricant Order Tax Invoice</title>
        <style>
            body {
    ...
    <body>
        ...
        <div class="bill-container">
            ...
            <div class="section" style="display: flex; justify-content: space-between; margin-bottom: 20px;">
                ...
                <p><span class="label">Tax Invoice ID:</span> TIN{{ $taxInvoice->id }}</p>
            </div>
            ...
            <div class="section">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>{{ $lubricantOrder->tax_holder_name }} </td>
                        <td class="label">Tax Number:</td>
                        <td>{{ $lubricantOrder->tax_number }}</td>
                    </tr>
                </table>
            </div>
            ...
            <div class="section">
                ...
                <table>
                    ...
                    @if (!empty($lubricantOrder->percentage))
                        <tr>
                            <td class="label">Tax (%):</td>
                            <td style="text-align: right;">{{ $lubricantOrder->percentage }} %</td>
                        </tr>
                    @endif
                    @if (!empty($taxInvoice))
                        <tr>
                            <td class="label">Tax Price (LKR):</td>
                            <td style="text-align: right;">{{ $taxInvoice->tax_paid }}</td>
                        </tr>
                    @endif
                    <tr>
