    ...
    <body>
        ...
        <div class="bill-container">
            ...
            <div class="section" style="display: flex; justify-content: space-between; margin-bottom: 20px;">
                ...
                <p><span class="label">Tax Invoice ID:</span> TIN{{ $batteryOrder->tax_invoice_id }}</p>
            </div>
            ...
            <div class="section">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>{{ $batteryOrder->customer->tax_holder_name }} </td>
                        <td class="label">Tax Number:</td>
                        <td>{{ $batteryOrder->customer->tax_number }}</td>
                    </tr>
                </table>
            </div>
                            ...
                            <tr>
                                <td class="label">
                                    ...
                                    @if (isset($item['old_battery_id']))
                                        @php
                                            $matchedOldBattery = $oldBatteries->firstWhere(
                                                'id',
                                                $item['old_battery_id'],
                                            );
                                        @endphp
            ...
            <div class="section">
                ...
                <table>
                    ...
                    @if (!empty($batteryOrder->percentage))
                        <tr>
                            <td class="label">Tax (%):</td>
                            <td style="text-align: right;">{{ $batteryOrder->percentage }} %</td>
                        </tr>
                    @endif
                    @if (!empty($batteryOrder->tax_invoice_id))
                        <tr>
                            <td class="label">Tax Price (LKR):</td>
                            <td style="text-align: right;">{{ $batteryOrder->taxInvoice->tax_paid }}</td>
                        </tr>
                    @endif
            ...
            <!-- Footer Section -->
            <div class="footer">
                <p class="prepared-by">Prepared By: {{ $batteryOrder->user->name }}</p>
