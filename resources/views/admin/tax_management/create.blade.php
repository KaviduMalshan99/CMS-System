            ...
            <div class="col-lg-12">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <form id="taxForm" action="{{ route('tax.store') }}" method="POST"enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            ...
                            <div class="mb-4">
                                <button type="submit" form="taxForm" class="btn btn-success col-md-3">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
