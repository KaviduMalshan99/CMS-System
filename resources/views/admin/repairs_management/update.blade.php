                    ...
                    <div class="card-body">
                        ...
                        <form id="repairForm" action="{{ route('repairs.update', $repair) }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="model_number" class="form-control" placeholder="Type here"
                            ...
                            <div class="row gx-3">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="number" name="advance_amount" class="form-control" placeholder="Type here"
                            ...
                            <div class="row gx-3">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select name="isForSelling" id="isforselling" class="form-select">
                                        <option value="0"
                                            {{ isset($repair->repairBattery) && $repair->repairBattery->isForSelling == 0 ? 'selected' : '' }}>
                                            NO</option>
                                        <option value="1"
                                            {{ isset($repair->repairBattery) && $repair->repairBattery->isForSelling == 1 ? 'selected' : '' }}>
                                            YES</option>
                                    </select>
