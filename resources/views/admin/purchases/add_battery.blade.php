                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <form id="saveForm" action="{{ route('purchases.store_battery') }}" method="POST">
                            ...
                            <div class="row gx-3">
                                <div class="col-md-6">
                                    <label for="battery_id" class="form-label">Battery <span
                                            class="txt-danger">*</span></label>
                                    <select id="battery_id" name="battery_id" class="form-select" required>
                                        ...
                                        @foreach ($batteries as $battery)
                                            <option value="{{ $battery->id }}"
                                                data-purchase-price="{{ $battery->purchase_price }}">{{ $battery->type }} |
                                                {{ $battery->type }}
                                                |
                            ...
                            <div class="mt-4 row gx-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" id="purchase_price" class="form-control" step="0.01" readonly
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            <label for="payment_type" class="form-label">Payment Type <span
                                    class="txt-danger">*</span></label>
                            <select id="payment_type" name="payment_type" class="form-select" id="mainSelect" required>
