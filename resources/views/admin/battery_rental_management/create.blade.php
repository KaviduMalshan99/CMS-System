                        ...
                        <form id="rentalForm" action="{{ route('rentals.store') }}" method="POST">
                            ...
                            <div class="row gx-3">
                                <div class="col-md-6 mb-4">
                                    <label for="old_battery_id" class="form-label">Old Battery <span
                                            class="txt-danger">*</span></label>
                                    <select name="old_battery_id" id="old_battery_id" class="form-select" required>
                                        <option value="" disabled selected>Select Old Battery</option>
                                        @foreach ($oldBatteries as $oldBattery)
                                            <option value="{{ $oldBattery->id }}">{{ $oldBattery->old_battery_type }}
                                                {{ $oldBattery->old_battery_condition }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <label for="old_battery_quantity my-2">Quantity <span
                                            class="txt-danger">*</span></label>
                            ...
                            <div class="row gx-3">
                                <div class="col-md-6 mb-4">
                                    <label for="rental_cost my-2">Rental Cost <span class="txt-danger">*</span></label>
                            ...
                            <div class="mb-4">
                                <button type="submit" form="rentalForm" class="btn btn-success col-md-3">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
