                    ...
                    <div class="card-body">
                        ...
                        <div class="row gx-3">
                            ...
                            <div class="col-md-2 mb-4">
                                <div>
                                    <a href="{{ route('rentals.create') }}" class="btn btn-primary btn-sm rounded">Create
                                        new</a>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul
                                                    ...
                                                    @if ($rental->tax_invoice_id)
                                                        <li class="btn btn-sm">
                                                            <a href="{{ route('rentals.taxInvoice', $rental->id) }}"
                                                                class="text-decoration-none">
                                                    ...
                                                    @endif
                                                    <li>
                                                        <form id="deleteForm{{ $rental->id }}"
                                                            action="{{ route('rentals.destroy', $rental->id) }}"
                                                            method="POST" style="display: inline;">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="button" class="delete btn btn-sm"
                                                                onclick="confirmDelete('deleteForm{{ $rental->id }}', 'Are you sure you want to delete this rental?')">
